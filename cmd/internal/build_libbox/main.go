...
import (
	...
	"github.com/fromil88/sing-box/cmd/internal/build_shared"
...
func init() {
	...
	sharedFlags = append(sharedFlags, "-ldflags", "-X github.com/fromil88/sing-box/constant.Version="+currentTag+" -s -w -buildid=")
	debugFlags = append(debugFlags, "-ldflags", "-X github.com/fromil88/sing-box/constant.Version="+currentTag)
